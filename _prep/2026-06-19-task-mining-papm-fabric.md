...
![Process with 2 recordings](2026-06-19-task-mining-papm-fabric/recordings-overview.png)

Here's an example of one of the recordings with its identified and grouped activities:

![Recording with identified activities](2026-06-19-task-mining-papm-fabric/recording-activities-detail.png)
...
![Track changes setting in Dataverse table properties](2026-06-19-task-mining-papm-fabric/dataverse-track-changes-setting.png)
...
![Linked tables in Power Apps](2026-06-19-task-mining-papm-fabric/powerapps-linked-tables.png)

**In Fabric:**

![Linked tables in Fabric](2026-06-19-task-mining-papm-fabric/fabric-linked-tables.png)
...
![Process Intelligence Studio with attribute filter](2026-06-19-task-mining-papm-fabric/process-intelligence-studio-filter.png)
...
![Azure SQL Server connector](2026-06-19-task-mining-papm-fabric/azure-sql-connector.png)

Configure it using the connection string and database name from your Fabric Lakehouse properties:

**Database name:**

![Database name in Lakehouse properties](2026-06-19-task-mining-papm-fabric/fabric-lakehouse-db-name.png)

**Connection string:**

![Connection string in Lakehouse properties](2026-06-19-task-mining-papm-fabric/fabric-lakehouse-connection-string.png)
